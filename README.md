...
```
model = await tf.loadModel('https://skin-disease-analyzer-tarp.netlify.app/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://skin-disease-analyzer-tarp.netlify.app/assets/samplepic.jpg");
```
